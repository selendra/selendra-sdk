...
import { AccountInfo, BalanceInfo, TransactionInfo, ContractInfo, EventSubscription } from '../types';
/**
...
export interface EventListProps extends HTMLAttributes<HTMLDivElement> {
    ...
    autoScroll?: boolean;
    /** Event filter */
    filter?: (event: EventSubscription) => boolean;
    /** Custom event renderer */
    renderEvent?: (event: EventSubscription, index: number) => ReactNode;
 ...
 * Export all types
 */
export type { SelendraContextValue, SelendraProviderProps, UseSelendraSDKReturn, UseBalanceOptions, UseBalanceReturn, UseAccountOptions, UseAccountReturn, UseTransactionOptions, UseTransactionReturn, UseContractOptions, UseContractReturn, UseEventsOptions, UseEventsReturn, UseBlockSubscriptionOptions, UseBlockSubscriptionReturn, WalletConnectorProps, BalanceDisplayProps, TransactionButtonProps, ConnectionStatusProps, EventListProps, FormatterOptions, ValidationRule, ValidationResult, ToastOptions, ErrorBoundaryState, LoadingState, SelendraTheme, ThemeProviderProps, DeFiDashboardTemplateProps, NFTMarketplaceTemplateProps, WalletTemplateProps, GovernanceTemplateProps };
