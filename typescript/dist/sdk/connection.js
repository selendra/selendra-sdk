...
class ConnectionManager {
    constructor(config) {
        ...
        Object.defineProperty(this, "substrateApi", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "evmProvider", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "networkConfig", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
    ...
    async connectSubstrate() {
        if (this.config.substrateProvider) {
            ...
            this.substrateApi = await api_1.ApiPromise.create({
            ...
            const provider = new api_1.WsProvider(endpoint, this.config.timeout);
            this.substrateApi = await api_1.ApiPromise.create({
                provider,
                throwOnConnect,
                initWasm: true
    ...
    async connectEvm() {
        if (this.config.evmProvider) {
            ...
            this.evmProvider = new ethers_1.ethers.JsonRpcProvider(endpoint, {
