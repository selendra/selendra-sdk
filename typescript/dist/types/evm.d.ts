 ...
 */
import type { Address, Balance, BlockHash, BlockNumber, ChainId, GasAmount, Nonce, TransactionHash } from './common';
/**
 * EVM transaction types
 */
export declare enum EvmTransactionType {
    LEGACY = "0x0",
    EIP_2930 = "0x1",
    EIP_1559 = "0x2"
}
...
export interface EvmContract {
    ...
    send(method: string, params: unknown[], overrides?: EvmTransactionRequest): Promise<TransactionHash>;
    /** Estimate gas for contract method call */
    estimateGas(method: string, params: unknown[], overrides?: EvmEstimateGasOptions): Promise<GasAmount>;
}
/**
