...
program
  ...
  .option('-n, --network <network>', 'Network to deploy to (mainnet|testnet|local)')
  .option('--args <args>', 'Constructor arguments (JSON array or comma-separated)')
...
program
  ...
  .option('-n, --network <network>', 'Network to query (mainnet|testnet|local)', 'mainnet')
...
program
  ...
  .argument('[action]', 'Action to perform (new|new-substrate|list|import)', 'list')
